...
function createDepsSelector() {
    ...
    var ret = memoize(function (state) {
        var e_1, _a;
        var params = [];
        try {
...
export function createDeps(stateGetterMap) {
    ...
    return {
        ...
        useMappedState: function (mapper, deps) {
            ...
            return useMappedState(stateGetters, function () { return mapper(stateProxy.getState()); }, deps);
        },
    };
}
