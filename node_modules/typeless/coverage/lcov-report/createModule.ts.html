...
<html lang="en">
<head>
    <title>Code coverage report for createModule.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> createModule.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">82.19% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>60/73</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { ChainedReducer } from './ChainedReducer';
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (getIsHmr()) {
<span class="cstat-no" title="statement not covered" >          if (actions &amp;&amp; actions.$remounted) {</span>
<span class="cstat-no" title="statement not covered" >            registry.dispatch(actions.$remounted());</span>
          }
        } else {
          store.initState();
          <span class="missing-if-branch" title="if path not taken" >I</span>if (actions &amp;&amp; actions.$mounted) {
<span class="cstat-no" title="statement not covered" >            registry.dispatch(actions.$mounted());</span>
          }
        }
      }, []);
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          if (actions &amp;&amp; actions.$unmounting) {</span>
<span class="cstat-no" title="statement not covered" >            registry.dispatch(actions.$unmounting());</span>
          }
<span class="cstat-no" title="statement not covered" >          if (store) {</span>
<span class="cstat-no" title="statement not covered" >            store.disable();</span>
          }
<span class="cstat-no" title="statement not covered" >          if (actions &amp;&amp; actions.$unmounted) {</span>
<span class="cstat-no" title="statement not covered" >            registry.dispatch(actions.$unmounted());</span>
          }
        };
      }, []);
    };
    ...
    handle.reset = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      epic = null;</span>
<span class="cstat-no" title="statement not covered" >      reducer = null;</span>
...
&nbsp;
  function withActions(newActionMap: object) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!hasState) {
      ret.withState = withState;
    } else {
<span class="cstat-no" title="statement not covered" >      ret.push(getState);</span>
    }
    return ret;
  }
&nbsp;
