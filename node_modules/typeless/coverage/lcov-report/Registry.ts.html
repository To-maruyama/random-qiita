...
<html lang="en">
<head>
    <title>Code coverage report for Registry.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> Registry.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as ReactDom from 'react-dom';
...
<span class="cstat-no" title="statement not covered" >    this.nameCount.clear();</span>
<span class="cstat-no" title="statement not covered" >    this.displayNames.clear();</span>
<span class="cstat-no" title="statement not covered" >    this.storesMap.clear();</span>
<span class="cstat-no" title="statement not covered" >    this.stores = [];</span>
<span class="cstat-no" title="statement not covered" >    this.initStreams();</span>
  }
&nbsp;
...
&nbsp;
  getStore(name: symbol) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.storesMap.has(name)) {
...
<span class="cstat-no" title="statement not covered" >        stateLogger = new StateLogger(this.stores);</span>
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (stateLogger) {
<span class="cstat-no" title="statement not covered" >        stateLogger.calcState('prev');</span>
      }
      for (const store of this.stores) {
        store.dispatch(action, notify);
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (stateLogger) {
<span class="cstat-no" title="statement not covered" >        stateLogger.calcState('next');</span>
<span class="cstat-no" title="statement not covered" >        stateLogger.log(action);</span>
      }
