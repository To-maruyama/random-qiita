...
<html lang="en">
<head>
    <title>Code coverage report for src/createModule.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> createModule.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
      React.useMemo(() =&gt; {
        ...
        if (!getIsHmr()) {
          store.initState();
          <span class="missing-if-branch" title="if path not taken" >I</span>if (actions &amp;&amp; actions.$init) {
<span class="cstat-no" title="statement not covered" >            registry.dispatch(actions.$init());</span>
          }
        }
      }, []);
&nbsp;
      React.useLayoutEffect(() =&gt; {
        if (getIsHmr()) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (actions &amp;&amp; actions.$remounted) {
        ...
        return () =&gt; {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (actions &amp;&amp; actions.$unmounting) {
<span class="cstat-no" title="statement not covered" >            registry.dispatch(actions.$unmounting());</span>
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (actions &amp;&amp; actions.$unmounted) {
