...
<html lang="en">
<head>
    <title>Code coverage report for src/createOutputStream.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> createOutputStream.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    .map(store =&gt; {
      ...
      return [
        ...
        ...(moduleHandlers.has(symbol) ? <span class="branch-0 cbranch-no" title="branch not covered" >moduleHandlers.get(symbol) </span>: []),
...
<span class="cstat-no" title="statement not covered" >              logAction(name, sourceAction);</span>
            }
            ...
            mergeMap((action: Action) =&gt; {
              <span class="missing-if-branch" title="if path not taken" >I</span>if (action == null) {
<span class="cstat-no" title="statement not covered" >                console.error('Undefined action returned in epic.', {</span>
                  action,
                  store: name,
                });
<span class="cstat-no" title="statement not covered" >                return empty();</span>
              }
              <span class="missing-if-branch" title="if path not taken" >I</span>if (!isAction(action)) {
<span class="cstat-no" title="statement not covered" >                console.error('Invalid action returned in epic.', {</span>
                  sourceAction,
                  action,
                  store: name,
                });
