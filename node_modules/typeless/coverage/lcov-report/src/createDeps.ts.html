...
<html lang="en">
<head>
    <title>Code coverage report for src/createDeps.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> createDeps.ts
    </h1>
    <div class='clearfix'>
...
<a name='L385'></a><a href='#L385'>385</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { StateGetter } from './types';
...
&nbsp;
    ...
    useMappedState(mapper, deps: any[] = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> {
