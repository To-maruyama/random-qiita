...
<html lang="en">
<head>
    <title>Code coverage report for src/ChainedReducer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> ChainedReducer.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { produce } from 'immer';
import {
  AC,
  Flatten,
  ExtractPayload,
...
const createNestedReducer = &lt;S, P extends keyof S&gt;(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof state === 'undefined') {
  ...
  asReducer() {
    if (!this.reducer) {
      ...
      Object.getOwnPropertyNames(ChainedReducer.prototype).forEach(key =&gt; {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof prop === 'function') {
...
<span class="cstat-no" title="statement not covered" >        throw new Error('fn must be a function');</span>
      }
      this.defaultReducers.push(createNestedReducer(prop, fn));
    } else {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof prop !== 'function') {
<span class="cstat-no" title="statement not covered" >        throw new Error('fn must be a function');</span>
      }
...
&nbsp;
  private getReducer() {
    return (state: S = this.initial, action: ActionLike) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!action.type) {
<span class="cstat-no" title="statement not covered" >        throw new Error('action.type must be defined');</span>
      }
