...
<html lang="en">
<head>
    <title>Code coverage report for src/onHmr.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> onHmr.tsx
    </h1>
    <div class='clearfix'>
...
export const startHmr = () =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!isHmr) {
    isHmr = true;
