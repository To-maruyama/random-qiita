...
<html lang="en">
<head>
    <title>Code coverage report for src/useMappedState.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> useMappedState.ts
    </h1>
    <div class='clearfix'>
  ...
  const stores = React.useMemo(
    () =&gt;
      stateGetters.map((getter: any) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!getter._store) {
...
<span class="cstat-no" title="statement not covered" >      subscriptions.forEach(<span class="fstat-no" title="function not covered" >su</span>bscription =&gt; <span class="cstat-no" title="statement not covered" >subscription())</span>;</span>
    };
  }, []);
&nbsp;
  React.useMemo(() =&gt; {
